...
const titles = [
  // 投稿数系
  {
    ...
    condition: { minPosts: 0 },
    rarity: TitleRarity.COMMON,
  },
  {
    name: "抹茶初心者",
    description: "5回の投稿を達成しました",
    type: TitleType.POST_COUNT,
    condition: { minPosts: 5 },
    rarity: TitleRarity.COMMON,
  },
  {
    name: "抹茶ファン",
  ...
  {
    name: "抹茶愛好家",
    description: "20回の投稿を達成しました",
    type: TitleType.POST_COUNT,
    condition: { minPosts: 20 },
    rarity: TitleRarity.RARE,
  },
  {
    name: "抹茶エキスパート",
  ...
  // 苦味系
  {
    ...
    condition: { minAvg: 0, maxAvg: 4.9 },
    rarity: TitleRarity.COMMON,
  },
  {
    name: "苦味愛好家",
    description: "苦味の魅力を知る者",
    type: TitleType.TASTE_BITTER,
    condition: { minAvg: 5, maxAvg: 6.9 },
    rarity: TitleRarity.RARE,
  },
  {
    name: "苦味マスター",
    description: "苦味を極めし者",
    type: TitleType.TASTE_BITTER,
    condition: { minAvg: 7, maxAvg: 7.9 },
    rarity: TitleRarity.EPIC,
  },
  {
    name: "苦味の求道者",
    description: "苦味の道を究める者",
    type: TitleType.TASTE_BITTER,
    condition: { minAvg: 8, maxAvg: 10 },
    rarity: TitleRarity.LEGENDARY,
  },
  ...
  {
    name: "味覚の調和者",
    description: "バランスの取れた味覚を持つ者",
    type: TitleType.TASTE_BALANCE,
    condition: { minAvg: 0, maxAvg: 3.9 },
    rarity: TitleRarity.COMMON,
  },
  {
    name: "バランス探求者",
    description: "調和を求める者",
    type: TitleType.TASTE_BALANCE,
    condition: { minAvg: 4, maxAvg: 5.9 },
    rarity: TitleRarity.RARE,
  },
  {
    name: "バランスマスター",
    description: "完璧な調和を理解する者",
    type: TitleType.TASTE_BALANCE,
    condition: { minAvg: 6, maxAvg: 7.9 },
    rarity: TitleRarity.EPIC,
  },
  {
    name: "完璧なバランサー",
    description: "究極の調和を体現する者",
    type: TitleType.TASTE_BALANCE,
    condition: { minAvg: 8, maxAvg: 10 },
    rarity: TitleRarity.LEGENDARY,
  },
